...
class DivisiResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Master Divisi';
    ...
    public static function form(Schema $schema): Schema { return DivisiForm::configure($schema); }
    public static function table(Table $table): Table { return DivisisTable::configure($table); }
